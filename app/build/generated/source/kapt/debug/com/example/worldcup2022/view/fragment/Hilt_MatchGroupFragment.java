 ...
 */
public abstract class Hilt_MatchGroupFragment<T extends ViewBinding> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MatchGroupFragment_GeneratedInjector) this.generatedComponent()).injectMatchGroupFragment(UnsafeCasts.<MatchGroupFragment>unsafeCast(this));
    }
  }
