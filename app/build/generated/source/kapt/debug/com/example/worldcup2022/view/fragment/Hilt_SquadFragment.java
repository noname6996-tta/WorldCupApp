 ...
 */
public abstract class Hilt_SquadFragment<T extends ViewBinding> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SquadFragment_GeneratedInjector) this.generatedComponent()).injectSquadFragment(UnsafeCasts.<SquadFragment>unsafeCast(this));
    }
  }
