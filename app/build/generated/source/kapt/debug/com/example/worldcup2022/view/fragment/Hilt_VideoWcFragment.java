 ...
 */
public abstract class Hilt_VideoWcFragment<T extends ViewBinding> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VideoWcFragment_GeneratedInjector) this.generatedComponent()).injectVideoWcFragment(UnsafeCasts.<VideoWcFragment>unsafeCast(this));
    }
  }
