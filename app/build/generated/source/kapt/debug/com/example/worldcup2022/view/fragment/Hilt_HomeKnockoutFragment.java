 ...
 */
public abstract class Hilt_HomeKnockoutFragment<T extends ViewBinding> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HomeKnockoutFragment_GeneratedInjector) this.generatedComponent()).injectHomeKnockoutFragment(UnsafeCasts.<HomeKnockoutFragment>unsafeCast(this));
    }
  }
