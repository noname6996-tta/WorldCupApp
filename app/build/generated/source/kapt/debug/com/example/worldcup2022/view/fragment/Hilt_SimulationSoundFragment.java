 ...
 */
public abstract class Hilt_SimulationSoundFragment<T extends ViewBinding> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SimulationSoundFragment_GeneratedInjector) this.generatedComponent()).injectSimulationSoundFragment(UnsafeCasts.<SimulationSoundFragment>unsafeCast(this));
    }
  }
