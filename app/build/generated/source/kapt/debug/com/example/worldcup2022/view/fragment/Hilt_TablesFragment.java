 ...
 */
public abstract class Hilt_TablesFragment<T extends ViewBinding> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TablesFragment_GeneratedInjector) this.generatedComponent()).injectTablesFragment(UnsafeCasts.<TablesFragment>unsafeCast(this));
    }
  }
