 ...
 */
public abstract class Hilt_GroupInfoFragment<T extends ViewBinding> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GroupInfoFragment_GeneratedInjector) this.generatedComponent()).injectGroupInfoFragment(UnsafeCasts.<GroupInfoFragment>unsafeCast(this));
    }
  }
