 ...
 */
public abstract class Hilt_GroupDetalsFragment<T extends ViewBinding> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GroupDetalsFragment_GeneratedInjector) this.generatedComponent()).injectGroupDetalsFragment(UnsafeCasts.<GroupDetalsFragment>unsafeCast(this));
    }
  }
