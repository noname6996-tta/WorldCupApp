 ...
 */
public abstract class Hilt_MatchInFragment<T extends ViewBinding> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MatchInFragment_GeneratedInjector) this.generatedComponent()).injectMatchInFragment(UnsafeCasts.<MatchInFragment>unsafeCast(this));
    }
  }
