 ...
 */
public abstract class Hilt_HomeMatchFragment<T extends ViewBinding> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HomeMatchFragment_GeneratedInjector) this.generatedComponent()).injectHomeMatchFragment(UnsafeCasts.<HomeMatchFragment>unsafeCast(this));
    }
  }
