...
public class WcFunFragmentDirections {
  ...
  @NonNull
  public static ActionWcFunFragmentToPlaySoundFragment2 actionWcFunFragmentToPlaySoundFragment2(
      int isInternet) {
    return new ActionWcFunFragmentToPlaySoundFragment2(isInternet);
  }
  ...
  public static class ActionWcFunFragmentToPlaySoundFragment2 implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionWcFunFragmentToPlaySoundFragment2(int isInternet) {
      this.arguments.put("isInternet", isInternet);
    }

    @NonNull
    @SuppressWarnings("unchecked")
    public ActionWcFunFragmentToPlaySoundFragment2 setIsInternet(int isInternet) {
      this.arguments.put("isInternet", isInternet);
      return this;
    }
    ...
    @Override
    public int getActionId() {
      return R.id.action_wcFunFragment_to_playSoundFragment2;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionWcFunFragmentToPlaySoundFragment2 that = (ActionWcFunFragmentToPlaySoundFragment2) object;
      if (arguments.containsKey("isInternet") != that.arguments.containsKey("isInternet")) {
        return false;
      }
      if (getIsInternet() != that.getIsInternet()) {
    ...
    @Override
    public String toString() {
      return "ActionWcFunFragmentToPlaySoundFragment2(actionId=" + getActionId() + "){"
          + "isInternet=" + getIsInternet()
          + "}";
    }
  }
