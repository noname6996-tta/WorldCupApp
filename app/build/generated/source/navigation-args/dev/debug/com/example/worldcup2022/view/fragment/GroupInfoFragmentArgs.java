...
public class GroupInfoFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private GroupInfoFragmentArgs() {
  }

  @SuppressWarnings("unchecked")
  private GroupInfoFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static GroupInfoFragmentArgs fromBundle(@NonNull Bundle bundle) {
    GroupInfoFragmentArgs __result = new GroupInfoFragmentArgs();
    bundle.setClassLoader(GroupInfoFragmentArgs.class.getClassLoader());
  ...
  public boolean equals(Object object) {
    ...
    GroupInfoFragmentArgs that = (GroupInfoFragmentArgs) object;
  ...
  public static class Builder {
    ...
    @SuppressWarnings("unchecked")
    public Builder(GroupInfoFragmentArgs original) {
    ...
    @NonNull
    public GroupInfoFragmentArgs build() {
      GroupInfoFragmentArgs result = new GroupInfoFragmentArgs(arguments);
      return result;
    }
