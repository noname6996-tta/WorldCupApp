...
public final class FragmentHomeBinding implements ViewBinding {
  ...
  private FragmentHomeBinding(@NonNull ConstraintLayout rootView, @NonNull CardView cardView,
      @NonNull ImageView imgHeader, @NonNull TabLayout tabLayout, @NonNull TextView tvDayCount,
      @NonNull TextView tvHoursCount, @NonNull TextView tvMinutesCount, @NonNull TextView tvSeconds,
  ...
  public static FragmentHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHomeBinding((ConstraintLayout) rootView, cardView, imgHeader, tabLayout,
          tvDayCount, tvHoursCount, tvMinutesCount, tvSeconds, viewPagerHome, viewRulerWhite);
    }
