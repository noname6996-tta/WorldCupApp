...
public final class FragmentWcfunBinding implements ViewBinding {
  ...
  @NonNull
  public final RelativeLayout rlFirstLayout;

  @NonNull
  public final RelativeLayout rlSencondLayout;
  ...
  private FragmentWcfunBinding(@NonNull ConstraintLayout rootView, @NonNull FrameLayout frameWcFun,
      @NonNull ImageView imgHeader, @NonNull RelativeLayout rlFirstLayout,
      @NonNull RelativeLayout rlSencondLayout, @NonNull RelativeLayout view9,
      @NonNull ImageView viewFirstLayout, @NonNull ImageView viewSencondLayout) {
    this.rootView = rootView;
    this.frameWcFun = frameWcFun;
    this.imgHeader = imgHeader;
    this.rlFirstLayout = rlFirstLayout;
    this.rlSencondLayout = rlSencondLayout;
    this.view9 = view9;
  ...
  public static FragmentWcfunBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.rlFirstLayout;
      RelativeLayout rlFirstLayout = ViewBindings.findChildViewById(rootView, id);
      if (rlFirstLayout == null) {
        break missingId;
      }

      id = R.id.rlSencondLayout;
      RelativeLayout rlSencondLayout = ViewBindings.findChildViewById(rootView, id);
      if (rlSencondLayout == null) {
        break missingId;
      }

      id = R.id.view9;
      RelativeLayout view9 = ViewBindings.findChildViewById(rootView, id);
      if (view9 == null) {
        break missingId;
      }
      ...
      return new FragmentWcfunBinding((ConstraintLayout) rootView, frameWcFun, imgHeader,
          rlFirstLayout, rlSencondLayout, view9, viewFirstLayout, viewSencondLayout);
    }
