...
public final class ItemMatchBinding implements ViewBinding {
  ...
  private ItemMatchBinding(@NonNull ConstraintLayout rootView, @NonNull CircleImageView imgTeam1,
      @NonNull CircleImageView imgTeam2, @NonNull ConstraintLayout layoutMatchInfo,
  ...
  public static ItemMatchBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMatchBinding((ConstraintLayout) rootView, imgTeam1, imgTeam2, layoutMatchInfo,
          tvFullTime, tvGroupMatch, tvStadiumMatch, tvTeam1, tvTeam2, tvTimeGoal, tvTimeMatch,
          view);
    }
