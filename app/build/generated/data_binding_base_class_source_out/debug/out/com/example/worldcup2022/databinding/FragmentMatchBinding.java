...
public final class FragmentMatchBinding implements ViewBinding {
  ...
  private FragmentMatchBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imgBell,
  ...
  public static FragmentMatchBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.imgBell;
      ImageView imgBell = ViewBindings.findChildViewById(rootView, id);
      if (imgBell == null) {
        break missingId;
      }
      ...
      return new FragmentMatchBinding((ConstraintLayout) rootView, imgBell, imgHeader, imgTeam2,
