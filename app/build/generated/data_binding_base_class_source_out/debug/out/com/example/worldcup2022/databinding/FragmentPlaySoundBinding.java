...
public final class FragmentPlaySoundBinding implements ViewBinding {
  ...
  private FragmentPlaySoundBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView imageView4, @NonNull ImageView imageView5, @NonNull View imgPlay,
      @NonNull ImageView ivBack, @NonNull SeekBar seekBar, @NonNull TextView textView14,
  ...
  public static FragmentPlaySoundBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPlaySoundBinding((ConstraintLayout) rootView, imageView4, imageView5,
          imgPlay, ivBack, seekBar, textView14, view11, viewBack);
    }
