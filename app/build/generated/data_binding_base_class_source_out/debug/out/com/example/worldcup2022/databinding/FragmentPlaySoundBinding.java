...
public final class FragmentPlaySoundBinding implements ViewBinding {
  ...
  private FragmentPlaySoundBinding(@NonNull ConstraintLayout rootView,
      @NonNull FrameLayout adContainer, @NonNull ImageView imageView2,
      @NonNull ImageView imageView4, @NonNull ImageView imageView5, @NonNull ImageView imgPlay,
      @NonNull SeekBar seekBar, @NonNull TextView tvNameSound, @NonNull View view11,
  ...
  public static FragmentPlaySoundBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPlaySoundBinding((ConstraintLayout) rootView, adContainer, imageView2,
          imageView4, imageView5, imgPlay, seekBar, tvNameSound, view11, viewBack);
    }
