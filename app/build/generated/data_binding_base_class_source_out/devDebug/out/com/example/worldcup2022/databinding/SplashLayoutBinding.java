...
public final class SplashLayoutBinding implements ViewBinding {
  ...
  @NonNull
  public final CircleImageView logoApp;

  private SplashLayoutBinding(@NonNull LinearLayout rootView, @NonNull CircleImageView logoApp) {
  ...
  public static SplashLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.logoApp;
      CircleImageView logoApp = ViewBindings.findChildViewById(rootView, id);
      if (logoApp == null) {
        break missingId;
      }

      return new SplashLayoutBinding((LinearLayout) rootView, logoApp);
    }
