...
public final class FragemntHomegroupBinding implements ViewBinding {
  ...
  private FragemntHomegroupBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imgHeader,
      @NonNull TabLayout tabLayoutHomeGroup, @NonNull ViewPager2 viewPagerHomeGroup,
      @NonNull View viewRuler) {
  ...
  public static FragemntHomegroupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragemntHomegroupBinding((ConstraintLayout) rootView, imgHeader,
          tabLayoutHomeGroup, viewPagerHomeGroup, viewRuler);
    }
