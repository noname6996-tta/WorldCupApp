...
public final class ItemHistoryMatchBinding implements ViewBinding {
  @NonNull
  ...
  private ItemHistoryMatchBinding(@NonNull ConstraintLayout rootView,
      @NonNull CardView cardViewTeam1, @NonNull CardView cardViewTeam2, @NonNull ImageView imgTeam1,
      @NonNull ImageView imgTeam2, @NonNull TextView txtGroup, @NonNull TextView txtGuess,
      @NonNull TextView txtTeam1, @NonNull TextView txtTeam2, @NonNull TextView txtTime) {
  ...
  @NonNull
  public static ItemHistoryMatchBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemHistoryMatchBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_history_match, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemHistoryMatchBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemHistoryMatchBinding((ConstraintLayout) rootView, cardViewTeam1, cardViewTeam2,
          imgTeam1, imgTeam2, txtGroup, txtGuess, txtTeam1, txtTeam2, txtTime);
    }
