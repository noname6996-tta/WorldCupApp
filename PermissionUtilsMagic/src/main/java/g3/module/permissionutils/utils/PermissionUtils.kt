 ...
 */
fun Activity.openAppDetailSettings() {
    val intent = Intent()
    intent.action = Settings.ACTION_APPLICATION_DETAILS_SETTINGS
    val uri = Uri.fromParts("package", packageName, null)
    intent.data = uri
    if (intent.resolveActivity(packageManager) != null) {
        startActivityForResult(intent, PermissionConstants.REQUEST_CODE_SETTING)
    }
}
 ...
 */
fun <T : Activity> T.requestPermissionsActivity(
 ...
 */
fun <T : Fragment> T.requestPermissionsFragment(
    activity: Activity,
    permissions: Array<String>,
    permissionRequestCode: Int,
    requestPermissionListener: RequestPermissionListener
    ...
    if (context.shouldAskPermissions(permissions)) {
        ...
        if (shouldShowRequestPermissionsRationale(permissions)) {
            ...
            if (context.isFirstTimeAskingPermissions(permissions)) {
                ...
                // Handle the feature without permission or ask user to manually allow permission
                requestPermissionListener.onPermissionPermanentlyDenied {
                    activity.openAppDetailSettings()
                }
            }
        }
    } else {
